<div class="bg-light">
  ...
  function showDetails(details, email, password) {
    $("#detailsModal p").html(decodeURIComponent(details)+"<br/><hr/><b class='font-bold'><?php echo lang("emailOrUsername"); ?>:</b> "+decodeURIComponent(email)+"<br/><b class='font-bold'><?php echo lang("aciklama"); ?></b> "+decodeURIComponent(password));
