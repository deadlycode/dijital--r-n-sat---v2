...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="name" max="255" value="{{ old('name') }}"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="input_slug" type="text" class="form-control" name="slug" max="255" required
                            value="{{ old('slug') }}">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-white">
                    ...
                    <div class="input-group mb-3" title="{{ __('(if there is a discount)') }}">
                        ...
                        <input type="number" class="form-control" name="old_price" value="{{ old('price') }}" step="0.01"
                            min="1">
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" placeholder="discount rate" min="1" max="90"
                            name="discount_rate">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="demo_url" max="255" value="{{ old('demo_url') }}">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-white">
                            {{ __('Admin Demo Url') }}
                        ...
                        <input type="text" class="form-control" name="admin_demo_url" max="255"
                            value="{{ old('admin_demo_url') }}">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-white">
                            {{ __('Whatsapp Phone') }}
                        </span>
                        <input type="text" class="form-control" name="whatsapp" max="255" value="{{ old('whatsapp') }}"
                            placeholder="{{__('Whatsapp Phone Number')}}">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-white">
                            {{ __('Image') }}
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="file" class="form-control" name="sliders[]" accept="image/*" multiple id="sliders">
                        <button type="button" class="btn btn-outline-secondary"
                    ...
                    <div class="mt-2">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="even_if_out_of_stock"
                                name="even_if_out_of_stock" value="1" checked>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body">
                    ...
                    <textarea placeholder="ID:PASS:KEY ... &#10;ID:PASS:KEY ..." class="form-control" id="output"
                        cols="30" rows="10" name="stocks" keyup="stock_count()"></textarea>
                    <span>
    ...
    <div class="row">
        <div class="col-lg-4 d-grid mx-auto">
