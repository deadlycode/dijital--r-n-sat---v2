                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input id="input_slug" type="text" class="form-control" name="slug"
                                            max="300" required
                                            placeholder="{{ __('SEO Url. It will be created automatically if you leave it blank') }}" value="{{ old('slug') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="text" max="300" name="description" value="{{ old('description') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
