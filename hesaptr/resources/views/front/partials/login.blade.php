...
<div class="d-grid">
    <a href="{{ url('login/google') }}" class="btn btn-outline-danger">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google mb-1"
            viewBox="0 0 16 16">
            <path
...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="mb-3 input-group">
        ...
        <input id="email" type="email" class="form-control" name="email" placeholder="{{ __('E-Mail Address')}}"
    ...
    <div class="mb-3 d-grid">
        <button type="submit" class="btn btn-primary">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-person-fill-check mb-1" viewBox="0 0 16 16">
                <path
